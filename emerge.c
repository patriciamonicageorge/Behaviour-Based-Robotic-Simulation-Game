...
while (repeat)
  ...
  for (i=0; i<TotalRobots; i++)
	...
	switch(i)
	  {
	  case 990:	/* this robot moves randomly */
		...
		break;
	  case 890:	/* this robot is greedy for food but ignores sharks */
	  ...
	  case 3:	/* this robot only avoids sharks (ignores food) */
		ScaredRobot(FoodClosestDistance,FoodClosestAngle,
					...
					&RobotMoveAngle,&RobotMoveEnergy);
		break;
		 case 0:	/* this robot only avoids sharks (ignores food) */
		zero(FoodClosestDistance,FoodClosestAngle,
					RobotClosestDistance,RobotClosestAngle,
					SharkClosestDistance,SharkClosestAngle,
					RobotEnergy[i],
					&RobotMoveAngle,&RobotMoveEnergy);
		break;
		case 1:	/* My Robot */
		one(FoodClosestDistance,FoodClosestAngle,
					RobotClosestDistance,RobotClosestAngle,
					SharkClosestDistance,SharkClosestAngle,
					RobotEnergy[i],
					&RobotMoveAngle,&RobotMoveEnergy);
		break;
		case 2:	/* My Robot */
		two(FoodClosestDistance,FoodClosestAngle,
					RobotClosestDistance,RobotClosestAngle,
					SharkClosestDistance,SharkClosestAngle,
					RobotEnergy[i],
					&RobotMoveAngle,&RobotMoveEnergy);
